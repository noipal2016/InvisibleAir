...
type Echo interface {
  ...
  //  - Req
  //  - Name
  Echo(ctx context.Context, req *EchoReq, name string) (r *EchoRes, err error)
}
...
//  - Req
//  - Name
func (p *EchoClient) Echo(ctx context.Context, req *EchoReq, name string) (r *EchoRes, err error) {
...
var retval *EchoRes
  var err2 error
  if retval, err2 = p.handler.Echo(ctx, args.Req, args.Name); err2 != nil {
...
func (p *EchoEchoArgs) GetName() string {
  return p.Name
}
...
func (p *EchoEchoArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *EchoEchoArgs) writeField2(oprot thrift.TProtocol) (err error) {
